...
import {BasePaymaster} from "@eth-infinitism/contracts/core/BasePaymaster.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";
import {UserOperationLib} from "@eth-infinitism/contracts/interfaces/UserOperation.sol";
/**
...
contract VerifyingPaymaster is BasePaymaster {
     ...
     */
    function _packValidationData(bool sigCheckFailed, uint48 validUntil, uint48 validAfter)
        private
        pure
        returns (uint256)
    {
        return uint256(sigCheckFailed ? 1 : 0) << 96 | uint256(validUntil) << 48 | uint256(validAfter);
    }
}
