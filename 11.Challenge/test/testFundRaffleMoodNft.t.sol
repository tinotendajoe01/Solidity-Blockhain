...
import { DeployMoodNft } from "../script/DeployFundRaffleNft.sol";
...
contract MoodNftTest is StdCheats, Test {
	...
	FundRaffleMoodNft public fundRaffleMoodNft;
	...
	function setUp() public {
		...
		fundRaffleMoodNft = deployer.run();
	}
	...
	function testCanMintAndHaveABalance() public {
		vm.prank(USER);
		fundRaffleMoodNft.mintNft(address(USER));

		assert(fundRaffleMoodNft.balanceOf(USER) == 1);
	}
